...
export function parseCF4Response(data) {
...
function attemptDiscovery(timeout) {
...
export async function wakeAndDiscover(maxRetries = UDP_MAX_RETRIES, timeout = UDP_TIMEOUT) {
